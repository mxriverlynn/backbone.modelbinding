...
Backbone.ModelBinding.DataBindBinding=function(){var b={};b._modelChange=function(a,c){b._setOnElement(this.element,this.elementAttr,c)};b._setOnElement=function(a,b,d){d===void 0&&(d="");switch(b){case "html":a.html(d);break;case "text":a.text(d);break;case "enabled":a.attr("disabled",!d);break;default:a.attr(b,d)}};b._splitBindingAttr=function(a){a=a.attr("data-bind").split(" ");return{elementAttr:a[0],modelAttr:a[1]}};b.bind=function(a,c,d){c.$(a).each(function(){var a=c.$(this),e=b._splitBindingAttr(a);
d.bind("change:"+e.modelAttr,b._modelChange,{element:a,elementAttr:e.elementAttr});b._setOnElement(a,e.elementAttr,d.get(e.modelAttr))})};b.unbind=function(a,c,d){c.$(a).each(function(){var a=c.$(this),a=b._splitBindingAttr(a);d.unbind("change:"+a.modelAttr,b._modelChange)})};return b}();
