...
a._getElementType(c));e.bind("change:"+b,a._modelChange,{element:c});c.bind("change",function(a){var c={};c[b]=d.$(a.target).val();e.set(c)});var f=e.get(b);typeof f!=="undefined"&&f!==null&&c.val(f)})};return a}();
Backbone.ModelBinding.SelectBoxBinding=function(){var a={_modelChange:function(a,d){this.element.val(d)}};a.unbind=function(b,d,e){d.$(b).each(function(){var c=d.$(this),c=Backbone.ModelBinding.Configuration.getBindingValue(c,"select");e.unbind("change:"+c,a._modelChange)})};a.bind=function(b,d,e){d.$(b).each(function(){var c=d.$(this),b=Backbone.ModelBinding.Configuration.getBindingValue(c,"select");e.bind("change:"+b,a._modelChange,{element:c});c.bind("change",function(a){var c={},a=d.$(a.target);
c[b]=a.val();c[b+"_text"]=a.find(":selected").text();e.set(c)});var f=e.get(b);typeof f!=="undefined"&&f!==null&&c.val(f)})};return a}();
...
d.$(this),f=Backbone.ModelBinding.Configuration.getBindingValue(b,"radio");if(!c[f]){c[f]=!0;b=Backbone.ModelBinding.Configuration.getBindingAttr("radio");e.bind("change:"+f,a._modelChange,{bindingAttr:b,group_name:f,view:d});d.$("input[type=radio]["+b+"="+f+"]").bind("change",function(a){a=d.$(a.currentTarget);if(a.attr("checked")){var c={};c[f]=a.val();e.set(c)}});var h=e.get(f);typeof h!=="undefined"&&h!==null&&d.$("input[type=radio]["+b+"="+f+"][value="+h+"]").attr("checked","checked")}})};return a}();
...
c.bind("change",function(a){var c={},a=d.$(a.target).attr("checked")?!0:!1;c[b]=a;e.set(c)});if(e.attributes.hasOwnProperty(b)){var f=e.get(b);typeof f!=="undefined"&&f!==null&&f!=!1?c.attr("checked","checked"):c.removeAttr("checked")}})};return a}();
Backbone.ModelBinding.DataBindBinding=function(){var a={},b={text:"",html:""};Backbone.ModelBinding.Configuration.dataBindSubst=function(a){this.storeDataBindSubstConfig();_.extend(b,a)};Backbone.ModelBinding.Configuration.storeDataBindSubstConfig=function(){Backbone.ModelBinding.Configuration._dataBindSubstConfig=_.clone(b)};Backbone.ModelBinding.Configuration.restoreDataBindSubstConfig=function(){if(Backbone.ModelBinding.Configuration._dataBindSubstConfig)b=Backbone.ModelBinding.Configuration._dataBindSubstConfig,
delete Backbone.ModelBinding.Configuration._dataBindSubstConfig};Backbone.ModelBinding.Configuration.getDataBindSubst=function(a,e){var c=e;b.hasOwnProperty(a)&&e===void 0&&(c=b[a]);return c};a._modelChange=function(d,b){a._setOnElement(this.element,this.elementAttr,b)};a._setOnElement=function(a,b,c){c=Backbone.ModelBinding.Configuration.getDataBindSubst(b,c);switch(b){case "html":a.html(c);break;case "text":a.text(c);break;case "enabled":a.attr("disabled",!c);break;case "displayed":a.css("display",
c?"block":"none");break;case "hidden":a.css("display",c?"none":"block");break;default:a.attr(b,c)}};a._splitBindingAttr=function(a){a=a.attr("data-bind").split(" ");a.length==1&&a.unshift("text");return{elementAttr:a[0],modelAttr:a[1]}};a.bind=function(b,e,c){e.$(b).each(function(){var b=e.$(this),d=a._splitBindingAttr(b);c.bind("change:"+d.modelAttr,a._modelChange,{element:b,elementAttr:d.elementAttr});a._setOnElement(b,d.elementAttr,c.get(d.modelAttr))})};a.unbind=function(b,e,c){e.$(b).each(function(){var b=
e.$(this),b=a._splitBindingAttr(b);c.unbind("change:"+b.modelAttr,a._modelChange)})};return a}();
