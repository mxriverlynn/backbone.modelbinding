...
c.bind("change",function(a){var c={},a=d.$(a.target).attr("checked")?!0:!1;c[b]=a;e.set(c)});if(e.attributes.hasOwnProperty(b)){var f=e.get(b);typeof f!=="undefined"&&f!==null?c.attr("checked","checked"):c.removeAttr("checked")}})};return a}();
